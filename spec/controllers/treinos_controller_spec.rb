...
RSpec.describe TreinosController, :type => :controller do
  ...
  describe "GET index" do
    it "assigns all treinos as @treinos" do
      ...
      expect(assigns(:treinos)).to eq([treino])
    end
  end
  ...
  describe "GET show" do
    it "assigns the requested treino as @treino" do
      ...
      expect(assigns(:treino)).to eq(treino)
    end
  end
  ...
  describe "GET new" do
    it "assigns a new treino as @treino" do
      ...
      expect(assigns(:treino)).to be_a_new(Treino)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created treino as @treino" do
        post :create, {:treino => valid_attributes}, valid_session
        expect(assigns(:treino)).to be_a(Treino)
        expect(assigns(:treino)).to be_persisted
      end

      it "redirects to the created treino" do
        post :create, {:treino => valid_attributes}, valid_session
        expect(response).to redirect_to(Treino.last)
      end
    end

    describe "with invalid params" do
      it "assigns a newly created but unsaved treino as @treino" do
        post :create, {:treino => invalid_attributes}, valid_session
        expect(assigns(:treino)).to be_a_new(Treino)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested treino" do
        treino = Treino.create! valid_attributes
        put :update, {:id => treino.to_param, :treino => new_attributes}, valid_session
        treino.reload
      ...
      it "redirects to the treino" do
        treino = Treino.create! valid_attributes
        put :update, {:id => treino.to_param, :treino => valid_attributes}, valid_session
        expect(response).to redirect_to(treino)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns the treino as @treino" do
        treino = Treino.create! valid_attributes
        put :update, {:id => treino.to_param, :treino => invalid_attributes}, valid_session
        expect(assigns(:treino)).to eq(treino)
      end
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the treinos list" do
      treino = Treino.create! valid_attributes
      delete :destroy, {:id => treino.to_param}, valid_session
      expect(response).to redirect_to(treinos_url)
    end
  end
